...
# app.add_url_rule('/rank', view_func=rank)
...
#         query = "SELECT * FROM my_account WHERE my_username = %s AND my_password = %s"
...
#             return jsonify({'success':True,'message': 'Login successful','token': token.decode('UTF-8')}), 200
#         # 否则，说明登陆失败
#         else:
